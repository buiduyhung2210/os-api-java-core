...
public class ItemServiceImpl implements ItemService {
	...
	public Item addItem(Item item) throws ItemNotFoundException {
		...
		if (item == null)
			throw new ItemNotFoundException("Please add valid Item Details...");
	...
	@Override
	public List<Item> viewAllItemList() throws ItemNotFoundException {

		List<Item> cList = itemRepository.findAll();

		if (cList.isEmpty()) {
			throw new ItemNotFoundException("No Item in List....");
		}
	...
	public List<Item> viewAllItemsByCategory(Category category) throws ItemNotFoundException {
		...
		if (listByCategory.isEmpty())
			throw new ItemNotFoundException(
					"No such Item with this category name = " + category.getCategoryName() + " exist");
