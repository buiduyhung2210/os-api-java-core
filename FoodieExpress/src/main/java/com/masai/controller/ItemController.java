...
public class ItemController {
	...
	@CrossOrigin(origins = "http://localhost:3000")
	public ResponseEntity<List<Item>> viewAllCustomerHandler() throws CustomerNotFound {

		List<Item> customers = itemService.viewAllItemList();
	...
	public ResponseEntity<List<Item>> viewAllItemsOfRestaurantHandler(@RequestBody Restaurant restaurant)
			throws ItemNotFoundException, RestaurantException {
